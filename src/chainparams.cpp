...
{
    const char* pszTimestamp = "Master GRC 27/Aug/2019 Brazil to reject G7 money to fight Amazon fires";
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // MGRC: 1 day
        consensus.nPowTargetSpacing = 2.5 * 60; // MGRC: 2.5 minutes
        ...
        static const char PREMINE_PUBKEY [131] = "045BEAFAB3E6685901F640CF6F97804C922AE80D7916EF0E5058C55B96C5B46D10AC582B64E3B0D9A0DC161D695E81E4CF1228671476940DA99B7813E0E213280F";
        static const char SPORK_ADDRESS  [35]  = "MMd2ZkSi7KQUAHqbTHmUFxJocyW5KGXLqa";
        ...
        genesis = CreateGenesisBlock(1566873909, 28917698, 0x1e0ffff0, 1, 300000000 * COIN, PREMINE_PUBKEY);
        consensus.hashGenesisBlock = genesis.GetHash();

        //LogPrintf("consensus.hashGenesisBlock main : %s ", genesis.GetHash().ToString());
        //LogPrintf("consensus.hashMerkleRoot main : %s ", genesis.hashMerkleRoot.ToString());

        assert(consensus.hashGenesisBlock == uint256S("0x4c01a0f2a6d1c3f8123dfe8b5c91ad15542e4df05952507a725cec7ad560f50a"));
        assert(genesis.hashMerkleRoot == uint256S("0x489479d784e0bd4b340479521abdb0e7dc05b2da16e945199cc148da7a4c3333"));

        // MGRC addresses start with 'M'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,50);
        // MGRC script addresses start with '7'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,16);
        // MGRC private keys start with '7' or 'X'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,204);
        // MGRC BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // MGRC BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();

        // TODO: Master GRC set correct BIP44 coin type
        nExtCoinType = 5;
...
public:
    CTestNetParams() {
        ...
        static const char ALERT_PUBKEY   [131] = "048240a8748a80a286b270ba126705ced4f2ce5a7847b3610ea3c06513150dade2a8512ed5ea86320824683fc0818f0ac019214973e677acd1244f6d0571fc5103";
        static const char PREMINE_PUBKEY [131] = "0488EDD357BEDA0BDC362A42D63CE71BD7C8728C05003CF471FE0D10A51164A0DFFE80C59271CD658605A8266BB9B98D74A131C4D0ECB78C7285CF05FC28B0F799";
        static const char SPORK_ADDRESS  [35]  = "maoBtFYCzVTi5jf1P2jUBdejMsmx5SFEa2";
        ...
        genesis = CreateGenesisBlock(1566873909, 3861367235UL, 0x1e0ffff0, 1, 300000000 * COIN, PREMINE_PUBKEY);
        consensus.hashGenesisBlock = genesis.GetHash();

        //LogPrintf("consensus.hashGenesisBlock test : %s ", genesis.GetHash().ToString());
        //LogPrintf("consensus.hashMerkleRoot test : %s ", genesis.hashMerkleRoot.ToString());

        assert(consensus.hashGenesisBlock == uint256S("0x0e7a1780c353280159ce33000464a76e27c6c654042558e3909e511e0fbb9908"));
        assert(genesis.hashMerkleRoot == uint256S("0xdf4cc37a22a96606741e2a8871193cba789641a58e8d1a32039c35eb4fac91b6"));

        vFixedSeeds.clear(); // For now there are no nodes in the network. Nodes should be added manually.
        vSeeds.clear();
        // TODO: Add dns seeds.

        // Testnet MGRC addresses start with 'm'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,110);
        // Testnet MGRC script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet MGRC BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet MGRC BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Testnet MGRC BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
...
public:
    CDevNetParams() {
        ...
        static const char ALERT_PUBKEY   [131] = "048240a8748a80a286b270ba126705ced4f2ce5a7847b3610ea3c06513150dade2a8512ed5ea86320824683fc0818f0ac019214973e677acd1244f6d0571fc5103";
        static const char PREMINE_PUBKEY [131] = "04A347DA5918C0C46586D8CBB4436B7241005A276664E5417906807F7EDFF5ECD19C101768D27FB3C45AAA89C1775DED05B3841C4F497691784D0F8DBC98921670";
        static const char SPORK_ADDRESS  [35]  = "mUvUEmsCCkX4k487y9Z6aykeGfjNbscikN";
        ...
        genesis = CreateGenesisBlock(1566873909, 1096447, 0x207fffff, 1, 300000000 * COIN, PREMINE_PUBKEY);
        consensus.hashGenesisBlock = genesis.GetHash();
        

        //LogPrintf("consensus.hashGenesisBlock dev : %s ", genesis.GetHash().ToString());
        //LogPrintf("consensus.hashMerkleRoot dev : %s ", genesis.hashMerkleRoot.ToString());
...
public:
    CRegTestParams() {
        ...
        static const char PREMINE_PUBKEY [131] = "04A37086230F8A36160E9168DCBD83E58E5D5D78F940AC67BA4B2FFE59640F47EDF78133D9E93CDD095A84319F36B37FF27DA395E232106CAC686CEBB29D63B53F";
        static const char SPORK_ADDRESS  [35]  = "mSCdXahxt6MzH38dg48bfH5AcTGGirkLBw";
        ...
        //LogPrintf("consensus.hashGenesisBlock reg : %s ", genesis.GetHash().ToString());
        //LogPrintf("consensus.hashMerkleRoot reg: %s ", genesis.hashMerkleRoot.ToString());

        assert(consensus.hashGenesisBlock == uint256S("0x768972b641930a5292e5e7120d5caa648edf23213d6297bc644c93d482594686"));
        assert(genesis.hashMerkleRoot == uint256S("0xbe32b320503337a08fa4bf67f3b6feb5c39dd157f2055c710f817fd942365178"));
        ...
        // Regtest MGRC addresses start with 'm'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,110);
        // Regtest MGRC script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest MGRC BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest MGRC BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest MGRC BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
