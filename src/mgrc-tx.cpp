...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s mgrc-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  mgrc-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mgrc transaction") + "\n" +
              "  mgrc-tx [options] -create [commands]   " + _("Create hex-encoded mgrc transaction") + "\n" +
              "\n";
