    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  mgrc-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the MGRC in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 MGRC, 0.01 MGRC, 0.1 MGRC, 1 MGRC and 10 MGRC -- sort of like the paper money you use every day.</li> \
